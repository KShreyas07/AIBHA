    ...
    <AppLayout>
      ...
      <div className="card">
        ...
        <div className="space-y-2">
          ...
          {reports.map((r) => (
            <div key={r.id} className="flex items-center justify-between rounded-lg border border-slate-800 px-4 py-3">
              <div>
                <p className="text-sm font-medium text-white">Full Health Report</p>
